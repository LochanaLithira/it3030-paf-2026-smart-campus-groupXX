...
public class TicketController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('VIEW_OWN_TICKETS') or hasAuthority('VIEW_ALL_TICKETS') or hasAuthority('VIEW_ASSIGNED_TICKETS')")
    ...
    @PreAuthorize("hasAuthority('UPDATE_TICKET_STATUS') or hasAuthority('CLOSE_TICKETS')")
